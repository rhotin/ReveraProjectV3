    ...
    private View.OnClickListener buttonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.app1:
                    // do something
                    Toast infoMsg1 = Toast.makeText(v.getContext(), "Call Nurse", Toast.LENGTH_LONG);
                    infoMsg1.setGravity(Gravity.CENTER, 0, 0);
                    infoMsg1.show();
                    break;
                case R.id.app2:
                    // do something
                    Toast infoMsg2 = Toast.makeText(v.getContext(), "Call Front Desk", Toast.LENGTH_LONG);
                    infoMsg2.setGravity(Gravity.CENTER, 0, 0);
                    infoMsg2.show();
                    break;
                case R.id.app3:
                    // do something
                    Toast infoMsg3 = Toast.makeText(v.getContext(), "Call 911", Toast.LENGTH_LONG);
