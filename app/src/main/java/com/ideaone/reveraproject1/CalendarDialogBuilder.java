...
/**
 * Created by hkarimi on 2015-11-12.
 */
...
public class CalendarDialogBuilder {
    ...
    // Constructor.
    public CalendarDialogBuilder(Context ctx) {
        this.context = ctx;
        //this.dateSetlistener = listener;
        this.alertBuilder = returnDialog();
    }

    public CalendarDialogBuilder(Context ctx,  long initialDate) {
        this.context = ctx;
        //this.dateSetlistener = listener;
    ...
    private void configCalendarView() {
        ...
        mCv.setBackgroundColor(context.getResources().getColor(R.color.white));
