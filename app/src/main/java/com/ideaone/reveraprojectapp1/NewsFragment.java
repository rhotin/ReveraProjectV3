...
//children of top linearlayout
        ...
        tv1Title.setTextSize(40 / getResources().getDisplayMetrics().density);
        tv1Title.setTextColor(Color.parseColor("#000000"));

        tvReadMore.setText("Read more ..");
        tvReadMore.setTextSize(25 / getResources().getDisplayMetrics().density);
        ...
        tv2Desc.setTextSize(30 / getResources().getDisplayMetrics().density);
